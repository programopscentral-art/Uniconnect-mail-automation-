...
export type UserRole = 'ADMIN' | 'PROGRAM_OPS' | 'UNIVERSITY_OPERATOR' | 'COS' | 'PM' | 'PMA' | 'BOA' | 'CMA' | 'CMA_MANAGER' | 'SET_REVIEWER' | 'PROPOSER' | 'FACULTY' | 'STUDENT' | 'STAKEHOLDER' | 'SUPPORT' | 'SME';
