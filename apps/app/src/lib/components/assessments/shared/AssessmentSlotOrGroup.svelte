...
<div class="flex flex-col border-black {className}">
  ...
  <div class="flex border-b border-black">
    <div
      class="w-10 border-r border-black flex items-center justify-center font-bold {textClass} tabular-nums"
    ...
    <div
      class="flex items-center justify-center font-bold text-xs tabular-nums px-2 border-l border-black {marksClass}"
    >
      <span>(</span>
      <AssessmentEditable
        value={String(
  ...
  <div class="flex {borderClass} border-y border-black bg-gray-50/10">
    ...
    <div
      class="flex-1 text-center font-black uppercase text-[11px] tracking-[0.5em] py-0.5"
    >
      OR
    </div>
