        ...
        >
          ...
          <div class="flex items-center space-x-2">
            <select
              ...
              class="text-[11px] font-bold py-1 px-2 rounded-lg border-none bg-transparent hover:bg-white dark:hover:bg-slate-800 cursor-pointer transition-all {statusColors[
                task.status
