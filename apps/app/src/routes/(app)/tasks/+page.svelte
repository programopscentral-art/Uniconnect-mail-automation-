<script lang="ts">
    ...
    const priorityColors: Record<string, string> = {
        URGENT: 'bg-red-100 text-red-700 border-red-200 dark:bg-red-900/30 dark:text-red-400 dark:border-red-800/50',
        ...
        MEDIUM: 'bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-900/30 dark:text-blue-400 dark:border-blue-800/50',
    ...
    const statusColors: Record<string, string> = {
        ...
        IN_PROGRESS: 'bg-indigo-50 text-indigo-700 border-indigo-100 dark:bg-indigo-900/20 dark:text-indigo-400 dark:border-indigo-800/50',
        COMPLETED: 'bg-green-50 text-green-700 border-green-100 dark:bg-green-900/20 dark:text-green-400 dark:border-green-800/50',
        CANCELLED: 'bg-gray-50 text-gray-700 border-gray-100 dark:bg-slate-800/30 dark:text-slate-500 dark:border-slate-700/50'
    };
