    ...
    <div class="space-y-6">
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
        <div>
          ...
          <input 
            ...
            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all text-gray-900 font-bold"
          >
        </div>
        <div>
          ...
          <div class="bg-white rounded-lg border border-indigo-200 p-4 space-y-3 shadow-inner">
            <div class="grid grid-cols-2 gap-3">
              <div>
                ...
                <input id="btn-text" type="text" bind:value={config.actionButtonText} placeholder="Pay Now" class="w-full px-3 py-1.5 text-sm border border-gray-300 rounded-md text-gray-900 font-medium">
              </div>
              <div>
                <label for="btn-url" class="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Button URL</label>
                <input id="btn-url" type="text" bind:value={config.actionButtonUrl} placeholder="{'{{PAY_LINK}}'}" class="w-full px-3 py-1.5 text-sm border border-gray-300 rounded-md text-gray-900 font-medium">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
        ...
        <textarea 
          ...
          class="w-full px-4 py-3 border border-gray-300 rounded-lg font-mono text-base focus:ring-2 focus:ring-indigo-500 outline-none transition-all resize-none text-gray-900"
        ></textarea>
      </div>
