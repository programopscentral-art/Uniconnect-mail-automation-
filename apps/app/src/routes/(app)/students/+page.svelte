...
<div class="space-y-6 w-full max-w-full overflow-hidden">
  <div class="flex flex-wrap justify-between items-center gap-4">
    <div class="flex-grow min-w-0">
      <h1 class="text-2xl font-bold text-gray-900 truncate">Contact List <span class="text-xs font-normal text-gray-400 opacity-50 ml-2">(Build: 5000)</span></h1>
  ...
  <div class="bg-white shadow-floating rounded-[2rem] border border-gray-100 relative">
