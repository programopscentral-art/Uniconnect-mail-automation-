  ...
  const adminNavigation = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ops-os-report-weekly", label: "Weekly Report", href: "/ops-os/report-weekly", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "fee-collection",     label: "Fee Collection",     href: "/fee-collection",     icon: "M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" },
